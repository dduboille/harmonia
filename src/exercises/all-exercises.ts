...
const COURS8_EXERCISES: SATBExercise[] = [
  ...
  },
  {
    ...
    solution: [
      ...
      { soprano: n("C",5), alto: n("G",4), tenor: n("E",4), bass: n("C",4) },
      { soprano: n("A",4), alto: n("F#",4), tenor: n("C",4), bass: n("D",3) },
      { soprano: n("B",4), alto: n("F#",4), tenor: n("D",4), bass: n("B",3) },
      { soprano: n("C#",5),alto: n("E",4),  tenor: n("A",3), bass: n("A",3) },
      { soprano: n("D",5), alto: n("F#",4), tenor: n("A",3), bass: n("D",3) },
    ],
  ...
  },
  {
    ...
    solution: [
      ...
      { soprano: n("E",5), alto: n("C",5), tenor: n("A",3), bass: n("A",3) },
      { soprano: n("F",5), alto: n("C",5), tenor: n("A",3), bass: n("F",3) },
      { soprano: n("E",5), alto: n("C",5), tenor: n("Bb",3),bass: n("C",3) },
      { soprano: n("F",5), alto: n("C",5), tenor: n("A",3), bass: n("F",3) },
    ],
  ...
  },
  {
    ...
    solution: [
      ...
      { soprano: n("F",5), alto: n("C",5), tenor: n("A",4), bass: n("F",3) },
      { soprano: n("G",5), alto: n("C",5), tenor: n("G",4), bass: n("G",3) },
...
const COURS9_EXERCISES: SATBExercise[] = [
  ...
  },
  {
    ...
    solution: [
      ...
      { soprano: n("F",5), alto: n("C",5), tenor: n("A",4), bass: n("C",3) },
      { soprano: n("E",5), alto: n("C",5), tenor: n("G",4), bass: n("C",3) },
    ],
  ...
  },
  {
    ...
    solution: [
      { soprano: n("E",5), alto: n("C",5), tenor: n("G",4), bass: n("C",4) },
      { soprano: n("D",5), alto: n("A",4), tenor: n("F",4), bass: n("B",3) },
      { soprano: n("C",5), alto: n("A",4), tenor: n("E",4), bass: n("A",3) },
      { soprano: n("Bb",4),alto: n("G",4), tenor: n("D",4), bass: n("G",3) },
      { soprano: n("A",4), alto: n("F",4), tenor: n("C",4), bass: n("F",3) },
      { soprano: n("G#",4),alto: n("E",4), tenor: n("B",3), bass: n("E",3) },
    ],
    hint: "La basse descend diatoniquement par degrés. Les voix supérieures suivent en mouvement parallèle.",
  ...
  },
  {
    ...
    solution: [
      ...
      { soprano: n("F",5), alto: n("C",5), tenor: n("A",4), bass: n("F",3) },
      { soprano: n("F",5), alto: n("C",5), tenor: n("Ab",4),bass: n("F",3) },
      { soprano: n("E",5), alto: n("C",5), tenor: n("G",4), bass: n("C",3) },
    ],
...
import { COURS38_EXERCISES, COURS39_EXERCISES, COURS40_EXERCISES } from "@/exercises/cours38-41-exercises";
