      ...
      <main style={{
        ...
        <div style={{ maxWidth: 480, textAlign: "center" }}>
          ...
          <div style={{
            ...
            color: "#BA7517", textTransform: "uppercase", marginBottom: 8,
          ...
          <p style={{
            ...
            Importez un fichier MusicXML et obtenez une analyse harmonique automatique complète — tonalité, degrés, fonctions, cadences, et commentaire pédagogique généré par l'IA.
          </p>
