...
const CM_ACCORDS = [
  { deg:"I",   chord:"Cm",    typeKey:"mineurTypeMineur",   fn:"Tonique",      fnColor:"#0F6E56", fnBg:"#E1F5EE", descKey:"mineurDegICmDesc",   keys:["Do:3","Mib:3","Sol:3"] },
  { deg:"II",  chord:"Ddim",  typeKey:"mineurTypeDiminue",  fn:"Sous-dom.",    fnColor:"#534AB7", fnBg:"#EEEDFE", descKey:"mineurDegIIDdimDesc", keys:["Ré:3","Fa:3","Lab:3"] },
  { deg:"III", chord:"Eb",    typeKey:"mineurTypeMajeur",   fn:"Tonique",      fnColor:"#0F6E56", fnBg:"#E1F5EE", descKey:"mineurDegIIIEbDesc",  keys:["Mib:3","Sol:3","Sib:3"] },
  { deg:"IV",  chord:"Fm",    typeKey:"mineurTypeMineur",   fn:"Sous-dom.",    fnColor:"#534AB7", fnBg:"#EEEDFE", descKey:"mineurDegIVFmDesc",   keys:["Fa:3","Lab:3","Do:4"] },
  { deg:"V",   chord:"G7",    typeKey:"mineurTypeDominante",fn:"Dominante",    fnColor:"#BA7517", fnBg:"#FAEEDA", descKey:"mineurDegVG7Desc",    keys:["Sol:3","Si:3","Ré:4","Fa:4"] },
  { deg:"VI",  chord:"Ab",    typeKey:"mineurTypeMajeur",   fn:"Tonique",      fnColor:"#0F6E56", fnBg:"#E1F5EE", descKey:"mineurDegVIAbDesc",   keys:["Lab:3","Do:4","Mib:4"] },
  { deg:"VII", chord:"Bdim",  typeKey:"mineurTypeDiminue",  fn:"Dominante",    fnColor:"#BA7517", fnBg:"#FAEEDA", descKey:"mineurDegVIIBdimDesc",keys:["Si:3","Ré:4","Fa:4"] },
];
...
const EMPRUNTS = [
  {
    ...
    fn: "Tonique",
    replaces: "C",
    descKey: "empruntsCmDesc",
    usageKey: "empruntsCmUsage",
  ...
  },
  {
    ...
    fn: "Sous-dominante",
    replaces: "F",
    descKey: "empruntsFmDesc",
    usageKey: "empruntsFmUsage",
  ...
  },
  {
    ...
    fn: "Tonique",
    replaces: "Am",
    descKey: "empruntsAbDesc",
    usageKey: "empruntsAbUsage",
  ...
  },
  {
    ...
    fn: "Tonique",
    replaces: "Em",
    descKey: "empruntsEbDesc",
    usageKey: "empruntsEbUsage",
...
const SUITES = [
  {
    id: "cycle",
    nameKey: "classiqueCycleName",
    subtitleKey: "classiqueCycleSubtitle",
    descKey: "classiqueCycleDesc",
    detailKey: "classiqueCycleDetail",
    progression: ["Cm2","Fm7","Bdim7","EbMaj7","AbMaj7","Dm7b5","G7","Cm"],
    color: "#0F6E56", bg: "#E1F5EE",
  },
  {
    id: "chaconne",
    nameKey: "classiqueChaconneName",
    subtitleKey: "classiqueChaconneSubtitle",
    descKey: "classiqueChaconneDesc",
    detailKey: "classiqueChaconneDetail",
    progression: ["Cm","Gm/Bb","Fm/Ab","G7"],
    color: "#534AB7", bg: "#EEEDFE",
  },
  {
    id: "napolitain",
    nameKey: "classiqueNapolitainName",
    subtitleKey: "classiqueNapolitainSubtitle",
    descKey: "classiqueNapolitainDesc",
    detailKey: "classiqueNapolitainDetail",
    ...
    <div style={S.wrap}>
      ...
      {activeSection === "mineur" && (
        <div>
          ...
          <p style={S.sbody}>{n("mineurBody1")}</p>

          <div style={S.warnBox} dangerouslySetInnerHTML={{ __html: n("mineurWarnBox") }} />

          <p style={S.sbody} dangerouslySetInnerHTML={{ __html: n("mineurBody2") }} />

          <div style={S.infoBox} dangerouslySetInnerHTML={{ __html: n("mineurInfoBox") }} />
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
              <thead>
                <tr style={{ borderBottom: "0.5px solid #e5e5e5" }}>
                  {[n("mineurThGamme"), n("mineurThStructure"), n("mineurThNotes"), n("mineurThProbleme")].map(h => (
              ...
              <tbody>
                {[
                  { gamme: n("mineurRowNaturelleLabel"),   struct:"T–½–T–T–½–T–T",   notes:"C D Eb F G Ab Bb", pb: n("mineurRowNaturellePb") },
                  { gamme: n("mineurRowHarmoniqueLabel"),  struct:"T–½–T–T–½–1½–½",  notes:"C D Eb F G Ab B",  pb: n("mineurRowHarmoniquePb") },
                ].map((row, i) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7,1fr)", gap: 5, marginBottom: 12 }}>
            {CM_ACCORDS.map((d, i) => (
              <div key={d.deg}
                ...
                <div style={{ fontSize: 10, color: "#888" }}>{n(d.typeKey)}</div>
          ...
          {selDeg !== null && (
            <div style={{ border: `0.5px solid ${CM_ACCORDS[selDeg].fnColor}`, borderRadius: 10, padding: "12px 16px", background: CM_ACCORDS[selDeg].fnBg, marginBottom: 12 }}>
              ...
              <p style={{ fontSize: 13, color: "#444", lineHeight: 1.6, margin: 0 }}>{n(CM_ACCORDS[selDeg].descKey)}</p>
            </div>
          )}
        </div>
      )}
      ...
      {activeSection === "emprunts" && (
        <div>
          ...
          <p style={S.sbody} dangerouslySetInnerHTML={{ __html: n("empruntsBody1") }} />

          <div style={S.infoBox} dangerouslySetInnerHTML={{ __html: n("empruntsInfoBox") }} />

          <p style={{ fontSize: 13, color: "#888", marginBottom: 16 }}>
            {n("empruntsClickEmprunt")}
          </p>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px" }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, fontWeight: 500, color: "#111" }}>
                    {n("empruntsBorrowedFrom")} <em>{e.from}</em>
                  </div>
                  <div style={{ fontSize: 11, color: "#888", marginTop: 2 }}>
                    {n("empruntsFunction")} {tr(e.fn)} — {n("empruntsReplaces")} {e.replaces}
                  </div>
                </div>
              ...
              {selEmprunt === i && (
                <div style={{ padding: "0 16px 14px", borderTop: `0.5px solid ${e.color}20` }}>
                  <p style={{ fontSize: 13, color: "#444", lineHeight: 1.65, margin: "10px 0 6px" }}>{n(e.descKey)}</p>
                  <p style={{ fontSize: 12, color: e.color, margin: "0 0 10px", fontStyle: "italic" }}>
                    {n("empruntsUsagePrefix")} {n(e.usageKey)}
                  </p>
                  <button
          ...
          <h3 style={{ fontSize: 14, fontWeight: 500, margin: "24px 0 8px", color: "#111" }}>
            {n("empruntsTableTitle")}
          </h3>
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
              <thead>
                <tr style={{ borderBottom: "0.5px solid #e5e5e5" }}>
                  {[n("empruntsThFonction"), n("empruntsThCMaj"), n("empruntsThCMin")].map(h => (
                    <th key={h} style={{ textAlign: "left", padding: "6px 10px", fontWeight: 500, color: "#666" }}>{h}</th>
                  ))}
                </tr>
              </thead>
          ...
          <div style={S.warnBox} dangerouslySetInnerHTML={{ __html: n("empruntsWarnBox") }} />
        </div>
      )}
      ...
      {activeSection === "classiques" && (
        <div>
          ...
          <p style={S.sbody}>{n("classiquesBody1")}</p>
          ...
          {SUITES.map((suite) => (
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: 12, color: "#888", fontStyle: "italic", marginBottom: 6 }}>{n(suite.subtitleKey)}</div>
                <p style={{ fontSize: 13, color: "#555", lineHeight: 1.65, margin: 0 }}>{n(suite.descKey)}</p>
              </div>

              {selSuite === suite.id && (
                <div style={{ padding: "0 16px 14px", borderTop: `0.5px solid ${suite.color}30` }}>
                  <p style={{ fontSize: 13, color: "#444", lineHeight: 1.65, margin: "10px 0 10px" }}>{n(suite.detailKey)}</p>
                  <div style={{
      ...
      {activeSection === "progressions" && (
        <div style={{ marginTop: 32 }}>
          ...
          {INVERSION_EXERCISES.filter(e => e.cours === 5).map(ex => (
