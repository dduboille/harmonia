  ...
  return (
    <div style={S.wrap}>
            ...
            >
              ...
              {activeStyle === style.id && (
                <div style={{ padding: "0 16px 16px", borderTop: `0.5px solid ${style.color}20` }}>
                  ...
                  <div style={S.tip}><strong>{n("stylesRetenir")}</strong> {style.tip}</div>
                </div>
              )}
            </div>
          ))}

          <div style={S.warnBox} dangerouslySetInnerHTML={{ __html: n("stylesWarnBox") }} />
        </div>
      )}
      ...
      {activeSection === "exercices" && (
        <div>
          <h2 style={S.h2}>{n("exH2")}</h2>
          <p style={S.p}>{n("exIntro")}</p>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      {answered && (
                        <span style={{
                          ...
                          {ex.choices[selected!].isCorrect ? n("exCorrect") : n("exIncorrect")}
                        </span>
                      )}
                    </div>
                    <div style={{ fontSize: 12, color: "#888", marginTop: 2 }}>
          ...
          {quizDone ? (
            <div style={{ textAlign: "center", padding: "2rem 0" }}>
              ...
              <div style={{ fontSize: 14, color: "#666", marginBottom: 20 }}>
                {quizScore >= 8 ? n("quizScoreGood") :
                 quizScore >= 6 ? n("quizScoreOk") :
                 n("quizScoreLow")}
              </div>
              <button
                onClick={resetQuiz}
            ...
            <div>
              ...
              {quizAnswered && (
                <button onClick={nextQuiz}
                  ...
                  {quizIdx + 1 < QUIZ_COUNT ? n("quizNextBtn") : n("quizSeeScoreBtn")}
                </button>
              )}
            </div>
          )}
