...
function AppNav() {
  ...
  const items = [
    ...
    { href: `/${locale}/cours`, icon: "♩", label: t("courses").toUpperCase(), active: active("cours") || active("cursus"), pro: false },
    {
      ...
      active: active("entrainement") || active("atelier") || active("dictee") || active("notes-etrangeres") || active("comparateur") || active("progressions") || active("generateur-satb"),
    },
    {
      href: `/${locale}/creation`, icon: "♬", label: t("creation").toUpperCase(), pro: false,
      active: active("creation") || active("composition") || active("composer") || active("squelette-harmonique") || active("releve"),
    },
    {
