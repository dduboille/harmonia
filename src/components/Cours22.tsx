    ...
    <div style={S.wrap}>
      ...
      {activeSection === "principe" && (
        <div>
          ...
          <p style={S.p} dangerouslySetInnerHTML={{ __html: n("principeIntro") }} />

          <div style={S.infoBox} dangerouslySetInnerHTML={{ __html: n("principeInfoBox") }} />
            ...
            >
              ...
              {activeTech === tech.id && (
                <div style={{ padding: "0 16px 16px", borderTop: `0.5px solid ${tech.color}20` }}>
                  ...
                  <div style={S.tip}><strong>{n("conseilLabel")}</strong> {tech.tip}</div>
                </div>
              )}
            </div>
          ))}

          <div style={S.warnBox} dangerouslySetInnerHTML={{ __html: n("principeWarnBox") }} />
        </div>
      )}
            ...
            >
              ...
              {activeAnalyse === analyse.id && (
                <div style={{ padding: "0 16px 16px", borderTop: `0.5px solid ${analyse.color}20` }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 12 }}>
                    <div style={{ background: "#f8f8f8", border: "0.5px solid #e5e5e5", borderRadius: 8, padding: "10px 12px" }}>
                      <div style={{ fontSize: 10, fontWeight: 600, color: "#888", textTransform: "uppercase" as const, letterSpacing: "0.08em", marginBottom: 8 }}>{n("analyseOriginal")}</div>
                      <div style={{ display: "flex", gap: 6, flexWrap: "wrap" as const, marginBottom: 8 }}>
                    ...
                    <div style={{ background: analyse.bg, border: `0.5px solid ${analyse.color}40`, borderRadius: 8, padding: "10px 12px" }}>
                      <div style={{ fontSize: 10, fontWeight: 600, color: analyse.color, textTransform: "uppercase" as const, letterSpacing: "0.08em", marginBottom: 8 }}>{n("analyseReharmonise")}</div>
                      <div style={{ display: "flex", gap: 6, flexWrap: "wrap" as const, marginBottom: 8 }}>
                  ...
                  <div style={S.infoBox}><strong>{n("analyseLabel")}</strong> {analyse.insight}</div>
                </div>
              )}
            </div>
          ))}
        ...
        <div>
          ...
          {quizDone ? (
            <div style={{ textAlign: "center", padding: "2rem 0" }}>
              ...
              >{n("quizNewQuiz")}</button>
            </div>
          ) : (
            <div>
              <div style={{ fontSize: 12, color: "#999", marginBottom: 10 }}>
                {n("quizQuestion")} {quizIdx + 1} / {QUIZ_COUNT}
                <span style={{ marginLeft: 12, color: "#bbb" }}>{ALL_QUESTIONS.length} {n("quizPool")}</span>
              </div>
