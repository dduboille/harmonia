...
const fr: Cours47Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["Do3 (unisson)", "Do2, aux contrebasses", "Do4", "Do1"],
      a: 1,
...
const en: Cours47Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["Do3 (unison)", "Do2, in the double basses", "Do4", "Do1"],
      a: 1,
...
const de: Cours47Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["Do3 (Einklang)", "Do2, in den Kontrabässen", "Do4", "Do1"],
      a: 1,
...
const es: Cours47Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["Do3 (unísono)", "Do2, en los contrabajos", "Do4", "Do1"],
      a: 1,
...
const it: Cours47Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["Do3 (unisono)", "Do2, ai contrabbassi", "Do4", "Do1"],
      a: 1,
...
const pt: Cours47Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["Do3 (uníssono)", "Do2, nos contrabaixos", "Do4", "Do1"],
      a: 1,
