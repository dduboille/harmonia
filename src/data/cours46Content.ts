...
const fr: Cours46Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["enchaîner sans respirer", "respirer quand même", "ralentir pour compenser", "accentuer l'arrivée"],
      a: 0,
    ...
    },
    {
      ...
      opts: ["le soprano, c'est la voix supérieure", "la basse, toujours", "l'alto : c'est lui qui conduit", "toutes également"],
      a: 2,
...
const en: Cours46Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["chain on without breathing", "breathe anyway", "slow down to compensate", "accent the arrival"],
      a: 0,
    ...
    },
    {
      ...
      opts: ["the soprano, it is the top voice", "the bass, always", "the alto: it is the one that leads", "all equally"],
      a: 2,
...
const de: Cours46Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["ohne Atmung weiterführen", "trotzdem atmen", "zum Ausgleich verlangsamen", "die Ankunft akzentuieren"],
      a: 0,
    ...
    },
    {
      ...
      opts: ["den Sopran, er ist die Oberstimme", "immer den Bass", "den Alt: er ist es, der führt", "alle gleich"],
      a: 2,
...
const es: Cours46Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["encadenar sin respirar", "respirar de todos modos", "ralentizar para compensar", "acentuar la llegada"],
      a: 0,
    ...
    },
    {
      ...
      opts: ["el soprano, es la voz superior", "el bajo, siempre", "el contralto: es él quien conduce", "todas por igual"],
      a: 2,
...
const it: Cours46Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["concatenare senza respirare", "respirare comunque", "rallentare per compensare", "accentare l'arrivo"],
      a: 0,
    ...
    },
    {
      ...
      opts: ["il soprano, è la voce superiore", "il basso, sempre", "il contralto: è lui che conduce", "tutte ugualmente"],
      a: 2,
...
const pt: Cours46Locale = {
  ...
  questions: [
    ...
    },
    {
      ...
      opts: ["encadear sem respirar", "respirar na mesma", "abrandar para compensar", "acentuar a chegada"],
      a: 0,
    ...
    },
    {
      ...
      opts: ["o soprano, é a voz superior", "o baixo, sempre", "o contralto: é ele que conduz", "todas igualmente"],
      a: 2,
