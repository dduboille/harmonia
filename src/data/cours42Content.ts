...
const fr: Cours42Locale = {
  ...
  refRows: [
    ...
    { chiffrage: "5 barrée", nom: "quinte diminuée", position: "état fondamental (accord diminué)", intervalles: "3ce mineure + 5te diminuée", exemple: "Basse Si → Si-Ré-Fa (viie degré)", accord: "vii°" },
    { chiffrage: "+5 (ou 5+)", nom: "quinte augmentée", position: "état fondamental (accord augmenté)", intervalles: "3ce majeure + 5te augmentée", exemple: "Do mineur harm., basse Mib → Mib-Sol-Si♮ (IIIe degré)", accord: "III+" },
...
const en: Cours42Locale = {
  ...
  refRows: [
    ...
    { chiffrage: "5 crossed out", nom: "diminished fifth", position: "root position (diminished chord)", intervalles: "minor 3rd + diminished 5th", exemple: "Bass Si → Si-Ré-Fa (7th degree)", accord: "vii°" },
    { chiffrage: "+5 (or 5+)", nom: "augmented fifth", position: "root position (augmented chord)", intervalles: "major 3rd + augmented 5th", exemple: "C harmonic minor, bass Mib → Mib-Sol-Si♮ (3rd degree)", accord: "III+" },
...
const de: Cours42Locale = {
  ...
  refRows: [
    ...
    { chiffrage: "durchgestrichene 5", nom: "verminderte Quinte", position: "Grundstellung (verminderter Akkord)", intervalles: "kleine Terz + verminderte Quinte", exemple: "Bass Si → Si-Ré-Fa (VII. Stufe)", accord: "vii°" },
    { chiffrage: "+5 (oder 5+)", nom: "übermäßige Quinte", position: "Grundstellung (übermäßiger Akkord)", intervalles: "große Terz + übermäßige Quinte", exemple: "Do-Moll harmonisch, Bass Mib → Mib-Sol-Si♮ (III. Stufe)", accord: "III+" },
...
const es: Cours42Locale = {
  ...
  refRows: [
    ...
    { chiffrage: "5 tachada", nom: "quinta disminuida", position: "estado fundamental (acorde disminuido)", intervalles: "3ª menor + 5ª disminuida", exemple: "Bajo Si → Si-Ré-Fa (VII grado)", accord: "vii°" },
    { chiffrage: "+5 (o 5+)", nom: "quinta aumentada", position: "estado fundamental (acorde aumentado)", intervalles: "3ª mayor + 5ª aumentada", exemple: "Do menor armónico, bajo Mib → Mib-Sol-Si♮ (III grado)", accord: "III+" },
...
const it: Cours42Locale = {
  ...
  refRows: [
    ...
    { chiffrage: "5 barrata", nom: "quinta diminuita", position: "stato fondamentale (accordo diminuito)", intervalles: "3ª minore + 5ª diminuita", exemple: "Basso Si → Si-Ré-Fa (VII grado)", accord: "vii°" },
    { chiffrage: "+5 (o 5+)", nom: "quinta eccedente", position: "stato fondamentale (accordo eccedente)", intervalles: "3ª maggiore + 5ª eccedente", exemple: "Do minore armonico, basso Mib → Mib-Sol-Si♮ (III grado)", accord: "III+" },
...
const pt: Cours42Locale = {
  ...
  refRows: [
    ...
    { chiffrage: "5 cortada", nom: "quinta diminuta", position: "estado fundamental (acorde diminuto)", intervalles: "3ª menor + 5ª diminuta", exemple: "Baixo Si → Si-Ré-Fa (VII grau)", accord: "vii°" },
    { chiffrage: "+5 (ou 5+)", nom: "quinta aumentada", position: "estado fundamental (acorde aumentado)", intervalles: "3ª maior + 5ª aumentada", exemple: "Do menor harmônico, baixo Mib → Mib-Sol-Si♮ (III grau)", accord: "III+" },
