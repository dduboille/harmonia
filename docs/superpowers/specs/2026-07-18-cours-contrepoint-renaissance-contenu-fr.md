...
**Vers le fleuri.** En contrepoint *fleuri* (proche de la 5e espèce, cours 13), on subdivise le contrepoint en valeurs plus brèves et l'on introduit les dissonances réglées de la section 5. Fragment fleuri sur les deux premières notes du cantus : contre **Ré4** (semi-brève), le contrepoint chante **Ré5 – Do5 – Si4 – La4** (quatre minimes) ; **seul le Do5 (7e) est dissonant** — note de passage conjointe sur temps faible reliant Ré5 (8ve) à Si4 (6te) —, tandis que **Si4 (6te) et La4 (5te) sont consonants**.
...
*Corrigé (voix supérieure)* : sur **Fa4** → **La4** (3ce) puis **Ré5** (6M, **préparation** du retard sur temps faible) ; le **Ré5** est **tenu (lié)** par-dessus la barre et devient une **7e** dissonante sur **Mi4** au **temps fort** (percussion), puis **résout Ré5 → Do♯5** (6M, résolution conjointe descendante, sensible par ficta) ; sur **Ré4** → **Ré5** (8ve, finale). Clausule dorienne : superius **Do♯5 → Ré5** (demi-ton montant) contre cantus **Mi4 → Ré4** (ton descendant) = **6M → 8ve**. C'est le **retard 7-6 préparé et lié** (aucune dissonance accentuée non préparée).
